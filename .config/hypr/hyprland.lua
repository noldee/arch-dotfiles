...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("rofi -show drun -theme ~/.config/rofi/config.rasi"))
...
-- Screenshots (Solo al portapapeles, sin guardar archivos)
...
-- Shutdown menu (Power menu)
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("~/.config/hypr/scripts/powermenu.sh"))
hl.bind("XF86PowerOff", hl.dsp.exec_cmd("~/.config/hypr/scripts/powermenu.sh")) -- Move active window to a workspace with mainMod + SHIFT + [0-9]
...
-- Window rules for Wofi (Animation and floating)
hl.window_rule({
	name = "wofi-styling",
	match = { class = "^wofi$" },
	float = true,
